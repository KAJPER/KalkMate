...
export const AI_MODELS: AiModelOption[] = [
  ...
  { id: "google/gemini-3.5-flash",       label: "Gemini 3.5 Flash",           provider: "Google",     note: "Szybki, dobre rozumowanie",           costMultiplier: 4,   vision: true  },
  { id: "anthropic/claude-opus-4.6",     label: "Claude Opus 4.6",            provider: "Anthropic",  note: "Najlepszy do rozumowania i pisania",  costMultiplier: 10,  vision: true  },
  { id: "anthropic/claude-sonnet-4.6",   label: "Claude Sonnet 4.6",          provider: "Anthropic",  note: "Świetny stosunek jakości do ceny",    costMultiplier: 6,   vision: true  },
  { id: "openai/gpt-5.4",                label: "GPT-5.4",                    provider: "OpenAI",     note: "Rozumowanie strukturalne",            costMultiplier: 6,   vision: true  },
  { id: "x-ai/grok-4.3",                 label: "Grok 4.3",                   provider: "xAI",        note: "Mocny na trudnych benchmarkach",      costMultiplier: 1.3, vision: true  },
  { id: "deepseek/deepseek-v3.2",        label: "DeepSeek V3.2",              provider: "DeepSeek",   note: "Tani specjalista od rozumowania",     costMultiplier: 0.2, vision: false },
  { id: "qwen/qwen3-coder",              label: "Qwen3 Coder",                provider: "Alibaba",    note: "Mocny do STEM",                       costMultiplier: 0.7, vision: false },
  { id: "meta-llama/llama-4-maverick",   label: "Llama 4 Maverick",           provider: "Meta",       note: "Szybki open-source od Meta",          costMultiplier: 0.3, vision: true  },
  { id: "mistralai/mistral-large-2512",  label: "Mistral Large 3",            provider: "Mistral",    note: "Europejski flagowy model",            costMultiplier: 0.7, vision: false },
  { id: "perplexity/sonar-pro",          label: "Sonar Pro",                  provider: "Perplexity", note: "AI z dostępem do internetu",          costMultiplier: 6,   vision: false },
];
