...
Komercyjny produkt edukacyjny skierowany do polskich uczniów przygotowujących się do matury — kalkulator naukowy, który wygląda i działa jak zwykły kalkulator, ale ma ukrytą kamerę i łączność WiFi. Gdy uczeń utknie na zadaniu, robi zdjęcie treści, a urządzenie w kilka sekund zwraca pełne, wytłumaczone rozwiązanie — bez telefonu, bez przeglądarki, bez powiadomień i rozpraszaczy typowych dla korzystania z aplikacji AI na smartfonie.

Celem jest tania, dyskretna alternatywa dla drogich korepetycji i chaotycznego szukania rozwiązań w internecie — narzędzie, które pomaga **zrozumieć** zadanie (pełny tok rozumowania), a nie tylko podaje wynik.
...
1. **Zdjęcie** — kamera OV2640 (ukryta w obudowie) fotografuje zadanie.
...
6. **Panika** — jeden klawisz natychmiast wraca do trybu zwykłego kalkulatora (np. podczas sprawdzianu).
...
<tr>
<td width="50%">
<img src="website/public/kalkulator-kalkmate-ukryta-kamera-zamknieta.png" alt="Tył obudowy kalkulatora, kamera całkowicie ukryta">
<p align="center"><sub>Tył obudowy — kamera całkowicie ukryta</sub></p>
</td>
<td width="50%">
...
| **Kamera** | OV2640, interfejs 8-bit parallel + I2C/SCCB, ukryta w obudowie |
